...
const ThemeDecorations = lazy(() => import("@/components/ThemeDecorations"));
...
const StaffContract = lazy(() => import("./pages/StaffContract"));
    ...
    <RouteErrorBoundary>
      <Suspense fallback={<PageLoader />}>
        <Routes location={location} key={location.pathname}>
          ...
          <Route path="/spin" element={<PageTransition><RequireAuth message="Login with Discord to spin the wheel."><Spin /></RequireAuth></PageTransition>} />
          ...
          <Route path="/staff-contract" element={<PageTransition><RequireAuth message="Login with Discord to access staff contracts."><StaffContract /></RequireAuth></PageTransition>} />
