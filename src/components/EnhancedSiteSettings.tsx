      ...
      <Card className="glass-effect border-border/20">
        ...
        <CardContent className="space-y-4">
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="flex items-center justify-between p-4 rounded-lg bg-muted/30 border border-border/50">
              <div className="space-y-0.5">
                <Label className="text-base">Hide Digital Memorial</Label>
                <p className="text-sm text-muted-foreground">Hide the Graveyard / Memorial page from all users (owner only)</p>
              </div>
              <Switch 
                checked={getValue("memorial_hidden") === "true"}
                onCheckedChange={() => toggleSetting("memorial_hidden")}
              />
            </div>
