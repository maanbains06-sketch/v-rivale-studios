...
import { Shield, Gift, Headphones, Clock, AlertTriangle, Info, ExternalLink, Lock } from "lucide-react";
...
const Spin = () => {
  ...
  useEffect(() => {
    const checkOwner = async () => {
      ...
      if (user) {
        ...
        setIsOwner(discordId === OWNER_DISCORD_ID);
      }
  ...
  const isHidden = siteSettings.spin_header_hidden;
