...
const Staff = () => {
  ...
  // Combined Staff Team - includes both moderation and general staff
      ...
      <main className="pb-16">
        <div className="container mx-auto px-4">
          ...
          {[
            ...
            { key: "staff", title: "Staff Team", subtitle: "Core team members providing essential services", icon: UserCheck, staff: combinedStaffTeam, centerSingle: true, noLimit: true },
